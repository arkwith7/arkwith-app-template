      ...
      <GridItem xs={12} sm={12} md={8}>
        <Card>
          <CardHeader color="info">
            <h4 className={classes.cardTitleWhite}>Material Dashboard React Tutorial</h4>
          </CardHeader>
          <CardBody>
            <div className={classes.center}>
              <p>
              Material Dashboard React is built on top of Material UI using create-react-app. 
              <br/>
              Click the documentation button for more details.
              </p>
              <Button
                round
                color="danger"
                target="_blank"
                href="https://demos.creative-tim.com/material-dashboard-react/?_ga=2.126414861.1213278542.1541757619-574810291.1539159030#/documentation/tutorial"
              >
                Documentation
              </Button>
            </div>
