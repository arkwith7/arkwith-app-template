...
import CRUDExample from '../views/CRUDExample/CRUDExample.jsx';
...
const arkwithRoutes = [
	...
	{
		path: '/crudexample',
		sidebarName: 'CRUD Example',
		navbarName: 'CRUD Example',
		icon: Edit,
	...
	{ redirect: true, path: '/', to: '/chat', navbarName: 'Redirect' },
];
